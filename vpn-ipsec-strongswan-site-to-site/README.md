...
![ESP Encapsulation (depuis GW-B WAN interface)](assets/wireshark/esp-packet-ping-GW-A-to-GW-B-interface-from-GWA.png)

![ESP Encapsulation (depuis GW-A WAN interface)](assets/wireshark/esp-packet-ping-GW-A-to-GW-B-interface_from_GWB.png)
